...
import { getProtected, patchProtected, postProtected } from "../../network/ApiService";
...
const EditAssetPageNew = ({ show, onClose }) => {
  ...
  const handleChange = (e) => {
    ...
    console.log("Dealer Id : ", e.target);
    ...
    if (type === "file") {
      ...
      }else if(name === "fem_class"){
        setNewAsset((prev) => ({ ...prev, [name]: Number(value) }));
      } else {
  ...
  const getAssetDetailsById = async () => {
    try {
  ...
  const handleAssetDetailsUpdateApi = async (e) =>{
    e.preventDefault();
    console.log("Asset update data",newAsset)
    try {
      const response = await patchProtected(`${API_END_POINTS.assets}${id}/`,newAsset);
      // console.log("response for updating asset",response);
      if(response){
        toast.success( response?.message || t("assets.create.fields.updateSuccess"));
        navigate('/dashboard')
      }
  ...
  return (
    <div className="overflow-y-auto  w-full min-h-screen bg-gray-100 pt-20  ">
      ...
      <form onSubmit={handleAssetDetailsUpdateApi} className="w-full px-4 py-6">
        {currentStep === 0 && (
          <>
        ...
        {currentStep === 1 && (
          <>
            ...
            <div className="row">
               ...
               <div className="col-md-4">  
                  ...
                  menus={[
                    ...
                    { value: "poor", option: t("assets.fields.conditions.poor")},
                    { value: "very_poor", option:  t("assets.fields.conditions.verypoor") } 
               ...
               <div className="col-md-4">  
                ...
                placeholder={t("createAsset.placeholder.enterOpticalCondition")}
                menus={[
                  { value: "", option: t("assets.fields.selectCondition") },
                  {
                    value: "new",
                  ...
                  { value: "3", option: t("assets.fields.opticalConditions.3") },
                  {
                    value: "4",
                    option: t("assets.fields.opticalConditions.4"),
                  },
                  { value: "5", option: t("assets.fields.opticalConditions.5") },
                  {
                    value: "6",
            ...
            />
              ...
              <div className="col-md-4">
                <InputField
                  ...
                  name="machine_width"
                  disabled={!isEditing}
                  value={newAsset.machine_width > 0 && newAsset.machine_width}
                  onChange={handleChange}
                  label={t("assets.create.fields.machineWidth")}
                  explanation="Width of the machine"
                  placeholder="0"
            ...
            <div className="col-md-4">
              <p style={{fontSize:"0.9rem",color:"blue",fontWeight:'600'}}>Battery Available</p>
              <label  >
                <input
                  type="radio"
                  name="battery"
                  ...
                  <div className="col-md-6">
                    <SelectField
                      ...
                      menus={[
                        ...
                        { value: "Lithium-Ion", option:  t("assets.options.lithium-ion")  },
                        { value: "Starter", option:  t("assets.options.starter") },
                        { value: "Waterless", option:  t("assets.options.waterless") },
                        { value: "Lead Acid", option:  t("assets.options.lead-acid")  },
                      ]}
                    />
                  </div>
                </div>
            ...
            <div className="col mb-2 mt-2">
              <p style={{fontSize:"0.9rem",color:"blue",fontWeight:'600'}}>Battery Charger Available</p>
              <label>
                <input
                  type="radio"
              ...
              <>
                <div className="row">
                  ...
                  <SelectField
                    ...
                    menus={[
                      { value: "", option: "--select--" },
                      { value: "Single-phase", option: t("assets.options.single-phase") },
                      { value: "Three-phase", option:  t("assets.options.three-phase")  },
                      { value: "HF", option:  t("assets.options.hf")  },
                      { value: "Integrated", option:  t("assets.options.integrated")  },
                    ]}
                  ...
                  <InputField
                    ...
                    placeholder={t("createAsset.placeholder.enterBatteryChargerType")}
                    maxLength={150}
                  />
                </div> */}
                </div>
            ...
            />
              ...
              name="closed_height"
              type="number"
              value={newAsset.closed_height}
              onChange={handleChange}
              disabled={!isEditing}
              label="Closed Height"
              explanation="Closed Height"
              placeholder="Enter Closed Height"
            />
              </div>
             ...
             <div className="row">
              <div className="col-md-4">  
                ...
                label={t("assets.create.fields.forkCarriage")}
                explanation="Fork carriage of the machine"
                placeholder={t("createAsset.placeholder.enterForkCarriage")}
              />
              </div>
             ...
             <div className="row">
              ...
              explanation="Front tires of the machine"
              menus={[
                { value: "bandages", option: t("assets.options.bandages") },
                { value: "pneumatic", option: t("assets.options.pneumatic") },
                { value: "polyurethane", option: t("assets.options.polyurethane")},
                { value: "solid_rubber", option: t("assets.options.solid-rubber") },
                { value: "super_elastic", option: t("assets.options.super-elastic") }
            ...
            />
              ...
              label={t("assets.create.fields.tiresFrontSize")}
              explanation="Front tires size of the machine"
              placeholder={t("createAsset.placeholder.enterTiresFrontSize")}
            />
              </div>
            ...
            <div className="row">
              ...
              label={t("assets.create.fields.tiresRearSize")}
              explanation="Rear tires size of the machine"
              placeholder={t("createAsset.placeholder.enterTiresRearSize")}
            />
              </div>
              ...
              <SelectField
                name="additional_equipment"
                value={newAsset?.additional_equipment}
                disabled={!isEditing}
                onChange={handleChange}
                label={t("assets.create.fields.selectEquipment")}
                explanation="Equipment of the machine"
                menus={[
                  { value: "third_valve", option: "3rd Valve" },
                  { value: "fourth_valve", option: "4th Valve" },
                  { value: "worklight_rear", option: "Work Light Rear" },
                  { value: "worklight_front", option: "Work Light Front" },
                  { value: "roof_cover", option: "Roof Cover" },
                  { value: "front_window", option: "Front Window" },
                  { value: "half_cabin", option: "Half Cabin" },
                  { value: "heating", option: "Heating" },
                  { value: "load_guard", option: "Load Guard" },
                  { value: "magnet_valve", option: "Magnet Valve" },
                  { value: "oil_separator", option: "Oil Separator" },
                  { value: "soot_filter", option: "Soot Filter" },
                  { value: "stvzo_compliant", option: "STVZO Compliant" },
                  { value: "full_cabin", option: "Full Cabin" },
                  { value: "explosion_proof", option: "Explosion-Proof" },
                  { value: "impulse_control", option: "Impulse Control" },
                  { value: "initial_lift", option: "Initial Lift" },
                  { value: "air_conditioning", option: "Air Conditioning" },
                  { value: "full_free_lift", option: "Full Free Lift" },
                  { value: "ce_certificate", option: "CE Certificate" }
                ]}
              />
              {/* {selectedEquipment === "other" && (
                <InputField
              ...
              <div className="col-md-4">
                <InputField
                  ...
                  label="Working Height"
                  explanation="Working height of the machine"
                  placeholder={t("createAsset.placeholder.enterWorkingHeight")}
                />
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-md-6">
                <InputField
                  ...
                  label="Battery Add Equipment"
                  explanation="Additional equipment for the battery"
                  placeholder={t("createAsset.placeholder.enterAdditionalEquipment")}
                  maxLength={150}
                />
              </div>
            </div> */}
        ...
        {currentStep === 2 && (
          <>
            ...
            />
              ...
              placeholder={t("createAsset.placeholder.enterContactInformation")}
              maxLength={150}
            />
              </div>
            </div>
            ...
            />
              ...
              label={t("assets.fields.dealerPrice")}
              explanation={t("assets.fields.explanation.dealerPrice")}
              placeholder={t("createAsset.placeholder.enterDealerPrice")}
            />
              </div>

              <div className="col-md-4">  
              <InputField
              name="dealer_price_netto"
              type="number"
              value={newAsset.dealer_price_netto}
              disabled={!isEditing}
              onChange={(e) =>
                setNewAsset({
                  ...newAsset,
                  dealer_price_netto: e.target.value,
                })
              }
              label={t("assets.fields.dealerPriceNetto")}
              explanation={t("assets.fields.explanation.dealerPriceNetto")}
              placeholder={t("createAsset.placeholder.enterDealerPriceNetto")}
            />
              </div>
             ...
             <div className="row">
              ...
              label="Dealer Country"
              explanation="Enter the dealer's country"
              placeholder={t("createAsset.placeholder.enterDealerCountry")}
              maxLength={50}
            />
              </div>
            ...
            />
              ...
              value={newAsset.dealer_contact_person}
              disabled={!isEditing}
              onChange={handleChange}
              label="Dealer Contact Owner"
              explanation="Enter the dealer contact owner's name"
              placeholder={t("createAsset.placeholder.enterDealerContactOwner")}
              maxLength={50}
            />
              </div>
            ...
            {/* <InputField
              name="dealer_website"
              value={newAsset.dealer_website}
              type="url"
              disabled={!isEditing}
              onChange={handleChange}
              label="Dealer Website"
              explanation="Enter the dealer's website"
              placeholder={t("createAsset.placeholder.enterDealerWebsite")}
            /> */}
            ...
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerOwnerTel")}
              /> */}
            ...
            {/* <InputField
                ...
                onChange={handleChange}
                placeholder={t("createAsset.placeholder.enterDealerServiceBrands")}
            ...
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerDescription")}
                maxLength={250}
              /> */}
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerLogoPicUrl")}
              /> */}
            {/* <InputField
                name="dealerPicUrl1"
                type="file"
            ...
            {/* <InputField
                name="dealer_id"
                value={newAsset.dealer_id}
                onChange={handleChange}
                placeholder={t("createAsset.placeholder.enterDealerId")}
                label="Dealer ID" 
            ...
            {/* <InputField
                name="detail_url"
                value={newAsset.detail_url}
                onChange={handleChange}
                label="Dealer Detail URL"
                explanation="Enter the dealer detail URL"
                placeholder={t("createAsset.placeholder.enterDealerDetailUrl")}
              /> */}
            ...
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerOwnerEmail")}
              /> */}
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerOwnerLanguage")}
                maxLength={150}
              /> */}
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerOwnerCustom")}
                maxLength={250}
              /> */}
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerContact1Name")}
                maxLength={50}
              /> */}
            ...
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerContact1Language")}
                maxLength={150}
              /> */}
            {/* <InputField
                name="dealerTrucksNo"
                ...
                placeholder={t("createAsset.placeholder.enterDealerTrucksNo")}
              /> */}
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerAttachmentNo")}
              /> */}
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerBatteryNo")}
              /> */}
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerChargerNo")}
              /> */}
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerAccessPlatforms")}
              /> */}
            {/* <InputField
                ...
                placeholder={t("createAsset.placeholder.enterDealerCleaningMachines")}
              /> */}
          </>
        )}
        {currentStep === 3 && (
          <>
            ...
            <div className="row">
              ...
              onChange={handleChange}
              placeholder={t("createAsset.placeholder.enterFinancialPartner")}
            ...
            />
              ...
              <div className="col-md-4">
                ...
                placeholder={t("createAsset.placeholder.enterFinancialContractClassification")}
                maxLength={150}
                disabled={!isEditing}
              />
              </div>
              ...
              <div className="col-md-4">
                  <InputField
                      ...
                      onChange={handleChange}
                      placeholder={t("createAsset.placeholder.enterFinancialContract")}
            ...
            <div className="col-md-4">
                <InputField
                    ...
                    explanation="Enter the financial contract number"
                      placeholder={t("createAsset.placeholder.enterFinancialContractNo")}
                    maxLength={150}
                    disabled={!isEditing}
                  />
            </div>
          ...
          <div className="row">
           ...
           <div className="col-md-4">
              <InputField
                    ...
                    placeholder={t("createAsset.placeholder.enterDurationInMonths")}
                  />
           </div>
                ...
                />
                      ...
                      <div className="row">
                          ...
                          <InputField
                            ...
                            type="file" 
                            disabled={!isEditing}
                            value={newAsset.upload_customer_contract}
                            onChange={handleChange}
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 justify-center sm:justify-start items-center my-3">
          {currentStep < steps.length - 1 && (
            <>
              
              {/* {
                  !isEditing ? <button type = "submit" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 -md text-sm sm:text-base w-full sm:w-auto" variant="primary" >
                  Edit
                </button> : ""
                } */}
              ...
              >
                BACK
              </button> : <button type = "button" className="bg-gray-200 text-black px-4 py-2 -md text-sm sm:text-base w-full sm:w-auto" variant="close" onClick={() => navigate("/dashboard")}>
              ...
              <button type = "submit" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 -md text-sm sm:text-base w-full sm:w-auto" variant="primary"  >
                Edit
              </button>
            </>
          )}
          {currentStep === steps.length - 1 && (
            <>
              ...
              {isEditing ? (
                  <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 -md text-sm sm:text-base w-full sm:w-auto" variant="primary" type="submit">
                    UPDATE ASSET
                  </button>
                ) : ""}
               {
...
export default EditAssetPageNew;
