...
const CreateAssetPage = ({ show, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto py-10 z-[999] w-full min-h-screen bg-gray-100 p-4 ">
      ...
      <form onSubmit={handleCreateAsset} className="w-full px-4 py-6">
        {currentStep === 0 && (
          <>
            {/* Truck basic information */}
            <h2 className="md:text-xl  font-medium mb-3">Asset/Asset</h2>
        ...
        <div className="">
          <SelectField
            ...
            menus={[
              ...
              { value: "dealer_search", option: t("assets.options.dealerSearch") },
              { value: "customer_search", option: t("assets.options.customerSearch") },
              { value: "rental_device", option:t("assets.options.rentalDevice") },
              { value: "homepage", option: t("assets.options.homepage") },
              { value: "manufacturer_page", option: t("assets.options.manufacturerPage") }
            ]}
          />
        </div>
        ...
        <div className="">
          <SelectField
            ...
            menus={[
              { value: "", option: t("assets.create.fields.selectVisibleOption") },
              { value: "dealer_search", option: t("assets.options.dealerSearch") },
              { value: "customer_search", option: t("assets.options.customerSearch") },
              { value: "rental_device", option:t("assets.options.rentalDevice") },
              { value: "homepage", option: t("assets.options.homepage") },
        ...
        <div className="">
          <SelectField
            ...
            menus={[
              { value: "", option: t("assets.fields.selectClassification") },
              { value: "trailer", option: t("assets.options.trailer") },
              { value: "tractor", option: t("assets.options.tractor") },
              // All other classification options as in original code
              { value: "battery", option: t("assets.options.battery") }
            ]}
          />
        </div>
        ...
        <div className="">
          <SelectField
            name="engine_type"
            value={newAsset.engine_type}
            onChange={handleChange}
            label={t("assets.fields.engineType")}
            explanation={t("assets.fields.explanation.engineType")}
            placeholder={t("createAsset.placeholder.enterEngineType")}
            menus={[
              { value: "", option: t("assets.fields.selectEngineType") },
              { value: "Diesel", option: t("assets.options.demo") },
              { value: "Electric", option: t("assets.options.electric") },
              { value: "LPG", option: t("assets.options.lpg") },
              { value: "Hand", option: t("assets.options.hand") },
              { value: "Gasoline-Gas", option: t("assets.options.gasoline-gas") },
              { value: "Natural Gas", option: t("assets.options.natural-gas") }
            ]}
          />
        </div>
        ...
        <div className="">
          <SelectField
            ...
            menus={[
              ...
              { value: "Like New", option: t("assets.fields.conditions.likenew") },
              { value: "Very Good", option: t("assets.fields.conditions.verygood") },
              { value: "Good", option: t("assets.fields.conditions.good") },
              { value: "Normal", option: t("assets.fields.conditions.normal") },
              { value: "Poor", option: t("assets.fields.conditions.bad") },
              { value: "Very Poor", option: t("assets.fields.conditions.verybad") },
            ]}
          />
        </div>
        ...
        <div className="">
          <SelectField
            ...
            menus={[
              { value: "", option: t("assets.fields.selectCurrencyType") },
        ...
        <div className="">
          <InputField
            ...
            placeholder={t("createAsset.placeholder.enterPriceDescription")}
          />
        </div>
        ...
        <div className="">
          <InputField
            ...
            placeholder={t("createAsset.placeholder.enterRentalPricePerDay")}
          />
        </div>
        ...
        <div className="">
          <InputField
            ...
            explanation={t("assets.fields.explanation.rentalPricePerWeek")}
            placeholder={t("createAsset.placeholder.enterRentalPricePerWeek")}
          />
        </div>
        ...
        <div className="">
          <InputField
            ...
            explanation={t("assets.fields.explanation.rentalPricePerMonth")}
            placeholder={t("createAsset.placeholder.enterRentalPricePerMonth")}
          />
        </div>
        ...
        <div className=" md:col-span-2 lg:col-span-3">
          <InputField
            ...
            explanation={t("assets.fields.explanation.rentalPriceDescription")}
            placeholder={t("createAsset.placeholder.enterRentalPriceDescription")}
          />
        </div>
      </div>
        ...
        {currentStep === 1 && (
          ...
          <div>
            <SelectField
              ...
              menus={[
                { value: "", option: t("assets.fields.selectCondition") },
                { value: "new", option: t("assets.fields.conditions.new") },
                { value: "like_new", option: t("assets.fields.conditions.likenew") },
                { value: "very_good", option: t("assets.fields.conditions.verygood") },
                { value: "good", option: t("assets.fields.conditions.good") },
                { value: "normal", option: t("assets.fields.conditions.normal") },
          ...
          <div>
            <SelectField
              ...
              menus={[
                { value: "", option: t("assets.fields.selectCondition") },
                { value: "new", option: t("assets.fields.opticalConditions.1") },
                { value: "2", option: t("assets.fields.opticalConditions.2") },
                { value: "3", option: t("assets.fields.opticalConditions.3") },
                { value: "4", option: t("assets.fields.opticalConditions.4") },
                { value: "5", option: t("assets.fields.opticalConditions.5") },
                { value: "6", option: t("assets.fields.opticalConditions.6") }
              ]}
            />
          </div>
      ...
      {/* Offer Numbers */}
      <div className="mb-8">
        <h3 className="text-lg font-semibold  text-gray-800">Offer Information</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          <div>
            <InputField
      ...
      <div className="mb-8">
        <h3 className="text-lg font-semibold  text-gray-800">Performance Specifications</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          <div>
            <InputField
              type="number"
      ...
      {/* Battery Section */}
      <div className="mb-8">
        <h3 className="text-lg font-semibold  text-gray-800">Battery Information</h3>
        <div className="">
          <p className="text-sm text-blue-600 font-semibold mb-2">Battery Available</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
            <div>
              <InputField
                ...
                placeholder={t("createAsset.placeholder.enterBatteryVoltage")}
              />
            </div>
            <div>
              <InputField
                ...
                placeholder={t("createAsset.placeholder.enterBatteryCapacity")}
                maxLength={50}
              />
            </div>
            <div>
              <InputField
                ...
                placeholder={t("createAsset.placeholder.enterBatteryCase")}
              />
            </div>
            <div>
              <SelectField
        ...
        <div className="mt-6 ">
          <p className="text-sm text-blue-600 font-semibold mb-2">Battery Charger Available</p>
          <div className="flex items-center space-x-6">
            <label className="inline-flex items-center">
              <input
                type="radio"
      ...
      <div className="mb-8">
        <h3 className="text-lg font-semibold  text-gray-800">{t("assets.create.sections.forksAndCarriage")}</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          <div>
            <InputField
              name="fork_carriage"
      ...
      {/* Tires Section */}
      <div className="mb-8">
        <h3 className="text-lg font-semibold  text-gray-800">{t("assets.create.sections.tires")}</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          <div>
            <SelectField
              name="tires_front"
