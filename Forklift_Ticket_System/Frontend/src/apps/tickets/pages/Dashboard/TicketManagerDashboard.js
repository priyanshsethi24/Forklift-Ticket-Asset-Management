...
const TicketManagerDashboard = () => {
  ...
  const handleViewTicket = async (ticket) => {
    ...
    try {
      ...
      setShowViewModal(false); // Close the modal on error
    } finally {
      setIsViewLoading(false);
    }
  };

  // Add state for create ticket modal and form
  ...
  useEffect(() => {
    // Check for the ticket assigned message in localStorage
    const message = localStorage.getItem("ticketAssignedMessage");
    if (message) {
      ...
      localStorage.removeItem("ticketAssignedMessage");
    }
  }, []);
  ...
  if (showLoader) {
    return (
      <DashboardLoader
        message={t("dashboard.loading_ticket_manager_dashboard")}
      />
    );
  }
          ...
          <div className="filter-container flex flex-col sm:flex-row items-center gap-2 md:gap-4 w-full md:w-auto">
            ...
            >
              <div className="custom-dropdown relative">
                ...
                {/* Dropdown Menu */}
                {statusDropdownOpen && (
                  <div className="absolute z-50 mt-1 w-full sm:w-[160px] bg-white border  shadow-lg max-h-60 overflow-auto left-0">
                    <ul className="py-1">
                      <li
            ...
            >
              <div className="custom-dropdown relative">
                ...
                <button
                  type="button"
                  className="flex justify-between items-center rounded w-full p-2 border  bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div className="w-full ">
              ...
              if (!expandedTicketId || expandedTicketId === ticket.ticket_id) {
                return (
                  <div
                    ...
                    className={`mb-3 border bg-white  shadow-sm hover:shadow-md transition-shadow ${
                  ...
                  >
                    ...
                    <div className="p-2   ">
                      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center  ">
                        <div className="w-full sm:w-screen">
                          <div className="flex flex-col space-y-2   ">
                            ...
                            <div className="flex flex-col sm:flex-row sm:space-x-4 text-sm text-gray-500  ">
                              ...
                              {ticket.last_updated && (
                                <span className="bg-gray-100 px-2 py-1">
                                  {/* Updated: {new Date(ticket.last_updated).toLocaleDateString("en-GB")} at{" "}
                        ...
                        <div className="flex md:justify-end md:items-center justify-between gap-2  w-full sm:w-1/4 mt-3 sm:mt-0">
                          <span
                          ...
                          {expandedTicketId === ticket.ticket_id ? (
                            ...
                            <div className="flex space-x-2">
                              ...
                              >
                                <FaEdit title={t("dashboard.buttons.edit")} />
                              </button> */}
                            </div>
                          )}
                        </div>
          ...
          {!expandedTicketId && (
            <div className="flex flex-wrap items-center justify-between  gap-2">
              ...
              {/* Page Numbers - Hidden on mobile, visible on sm and up */}
                ...
                {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-8 h-8 flex items-center justify-center -full text-sm ${
                        currentPage === pageNum
              ...
              {/* Page Indicator - Looks better on all screen sizes */}
              <span className="text-sm text-gray-600 bg-gray-50 px-3 py-1.5  ml-auto">
